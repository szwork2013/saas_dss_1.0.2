!function() {
  ...
  d3.text = d3_xhrType(function(request) {
     ...
     * If a callback is specified, the request is immediately issued with the GET method,
     * and the callback will be invoked asynchronously when the file is loaded or the request fails;
     ...
     * If no callback is specified, the returned request can be issued using xhr.get or similar, and handled using xhr.on.
     */
